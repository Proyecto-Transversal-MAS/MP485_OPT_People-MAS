...
public class ReadAll extends javax.swing.JDialog {
    ...
    // Declaramos atributo controller
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIF", "Name", "Email", "Date of Birth", "Photo"
            }
        ) {
    ...
    private void exportDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportDataActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al exportar:" + ex.getMessage(), "Export error", JOptionPane.ERROR_MESSAGE);
        }
